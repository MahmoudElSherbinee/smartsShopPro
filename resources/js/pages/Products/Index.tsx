            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <button
                        ...
                        className="md:hidden w-full bg-gray-100 text-gray-700 py-2 rounded-lg mb-4"
                    >
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        {/* Filters Sidebar */}
                        <div className={`${sidebarOpen ? 'block' : 'hidden'} md:block md:w-1/4`}>
                                ...
                                <>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                        {products.data.map(product => (
                                            <div
                                                key={product.id}
                                                className="border rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300 bg-white"
                                            >
                                                {/* Product Image */}
